...
def evaluate_model():
    ...
    validation_generator = validation_datagen.flow_from_directory(
        validation_dir,
        target_size=(200, 200),  # Resize images to the model's input size (adjust as needed)
        batch_size=32,
    ...
    print(f"Evaluation results - Loss: {loss * 100:.2f}%, Accuracy: {accuracy * 100:.2f}%")
    ...
    print("Done evaluation, now you can run xai.py for AI Explainability.")
